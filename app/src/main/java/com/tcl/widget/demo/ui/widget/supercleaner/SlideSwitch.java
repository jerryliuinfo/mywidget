...
public class SlideSwitch extends View {
	...
	public SlideSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.my_slides_witch);
		color_theme = a.getColor(R.styleable.slideswitch_themeColor,
				DEFAULT_COLOR_THEME);
		isOpen = a.getBoolean(R.styleable.my_slides_witch_is_open, false);
		shape = a.getInt(R.styleable.my_slides_witch_switch_shape, SHAPE_RECT);
		a.recycle();
	}
